...
-  They protect web traffic coming in and out of the network, also they protect applications from threats.The jumpbox serves as a gateway into the Subnet of the Virtual Network_
